...
function StackedKestrel.analyse(binary_path)
    ...
    -- Layer 3: Full analysis (with SIMD available in matrix ops)
    local result = StackedKestrel.router.analyze_binary(binary_path)
...
function StackedKestrel.get_stats()
    ...
    return {
        ...
        cache_hit_rate = cache_stats.cloak_rate_percent,
